...
public class SpeakingWordProbService implements PracticeSearchInterface {
    ...
    @Transactional
    @Override
    public SpeakingProb getPractice(Long wordId) throws BadRequestException, InternalServerException {
        Word word = getWordOrElseThrow(wordId);
        return getSpeakingProbOrElseThrow(word);
    }
    ...
    private SpeakingProb getSpeakingProbOrElseThrow(Word word) {
    ...
    public SpeakingProb getRandomPractice(Long onsetId) throws BadRequestException {
        ...
        return getSpeakingProbOrElseThrow(randomWord);
    }
